...
@section('content')
    <div class="container-fluid pt-2">
        ...
        <div>
            <img src="{{ asset('uploads/home/pic9.jpg') }}" alt="img" srcset="" height="600" width="1000">
        </div>
        ...
        <br>
          ...
          <div class="">
            <div class="card p-5 mb-3 border">
              {{-- <img class="card-img-top img-fluid1" src="{{ asset('uploads/home/pic9.jpg') }}" alt="Card image cap"> --}}
              <div class="card-body">

                <div class="card  text-white">
                  <img class="card-img" src="{{ asset('uploads/home/bg1.jpg') }}" alt="Card image">
          ...
          <div class="card">
            <div class="card-body  text-black">
              <img class="card-img cmg1" src="{{ asset('uploads/home/bg1.jpg') }}" alt="Card image">
              <div class="card-img-overlay">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                <p class="card-text">Last updated 3 mins ago</p>
        ...
        <div class="card p-5">
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident ullam autem praesentium impedit veritatis id ad perspiciatis. Officia delectus deleniti laudantium magnam voluptate quos explicabo magni, recusandae labore quidem omnis.</div>
            <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi sit veniam provident? Sunt vel libero necessitatibus eius unde. Harum reprehenderit ipsum ullam deleniti minus velit provident inventore ipsam earum rerum?</div>
