        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="collapseSession" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav>
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link pl-5" href="{{ URL::to('admin/session') }}">Create Session</a>
                            <a class="nav-link pl-5" href="{{ URL::to('admin/view-session') }}">View All Session</a>
                        </nav>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link pl-5" href="layout-static.html">Static Navigation</a>
                        <a class="nav-link pl-5" href="layout-sidenav-light.html">Light Sidenav</a>
                    </nav>
                </div>
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                    <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
